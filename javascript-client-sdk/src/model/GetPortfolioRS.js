...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EasyTravelApi.GetPortfolioRS = factory(root.EasyTravelApi.ApiClient, root.EasyTravelApi.Country);
  }
  ...
  /**
   * The GetPortfolioRS model module.
   * @module model/GetPortfolioRS
   * @version 0.1.9
   */

  /**
   * Constructs a new <code>GetPortfolioRS</code>.
   * Container for the getportfolio response
   * @alias module:model/GetPortfolioRS
   * @class
   */
  ...
  /**
   * Constructs a <code>GetPortfolioRS</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetPortfolioRS} obj Optional instance to populate.
   * @return {module:model/GetPortfolioRS} The populated <code>GetPortfolioRS</code> instance.
   */
