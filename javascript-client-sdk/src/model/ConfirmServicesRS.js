...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EasyTravelApi.ConfirmServicesRS = factory(root.EasyTravelApi.ApiClient);
  }
  ...
  /**
   * The ConfirmServicesRS model module.
   * @module model/ConfirmServicesRS
   * @version 0.1.9
   */

  /**
   * Constructs a new <code>ConfirmServicesRS</code>.
   * Container for the service confirmation response
   * @alias module:model/ConfirmServicesRS
   * @class
   */
  ...
  /**
   * Constructs a <code>ConfirmServicesRS</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConfirmServicesRS} obj Optional instance to populate.
   * @return {module:model/ConfirmServicesRS} The populated <code>ConfirmServicesRS</code> instance.
   */
