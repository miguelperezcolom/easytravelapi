...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Amount', 'model/Stay'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Amount'), require('./Stay'));
  } else {
    // Browser globals (root is window)
    if (!root.EasyTravelApi) {
      root.EasyTravelApi = {};
    }
    root.EasyTravelApi.HotelBooking = factory(root.EasyTravelApi.ApiClient, root.EasyTravelApi.Amount, root.EasyTravelApi.Stay);
  }
}(this, function(ApiClient, Amount, Stay) {
  'use strict';
  ...
  /**
   * The HotelBooking model module.
   * @module model/HotelBooking
   * @version 0.1.9
   */

  /**
   * Constructs a new <code>HotelBooking</code>.
   * A booking service
   * @alias module:model/HotelBooking
   * @class
   */
  ...
  /**
   * Constructs a <code>HotelBooking</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HotelBooking} obj Optional instance to populate.
   * @return {module:model/HotelBooking} The populated <code>HotelBooking</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('stays')) {
        obj['stays'] = ApiClient.convertToType(data['stays'], [Stay]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/Stay>} stays
   */
  exports.prototype['stays'] = undefined;
