...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EasyTravelApi.UpdateRS = factory(root.EasyTravelApi.ApiClient);
  }
  ...
  /**
   * The UpdateRS model module.
   * @module model/UpdateRS
   * @version 0.1.9
   */

  /**
   * Constructs a new <code>UpdateRS</code>.
   * Container for the update method response
   * @alias module:model/UpdateRS
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateRS</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateRS} obj Optional instance to populate.
   * @return {module:model/UpdateRS} The populated <code>UpdateRS</code> instance.
   */
