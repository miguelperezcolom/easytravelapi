...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Allocation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Allocation'));
  } else {
    // Browser globals (root is window)
    if (!root.EasyTravelApi) {
      root.EasyTravelApi = {};
    }
    root.EasyTravelApi.Option = factory(root.EasyTravelApi.ApiClient, root.EasyTravelApi.Allocation);
  }
}(this, function(ApiClient, Allocation) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('distribution')) {
        obj['distribution'] = ApiClient.convertToType(data['distribution'], [Allocation]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/Allocation>} distribution
   */
