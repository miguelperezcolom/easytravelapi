...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EasyTravelApi.BookHotelRS = factory(root.EasyTravelApi.ApiClient);
  }
  ...
  /**
   * The BookHotelRS model module.
   * @module model/BookHotelRS
   * @version 0.1.9
   */

  /**
   * Constructs a new <code>BookHotelRS</code>.
   * Container for the hotel booking confirmation response
   * @alias module:model/BookHotelRS
   * @class
   */
  ...
  /**
   * Constructs a <code>BookHotelRS</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BookHotelRS} obj Optional instance to populate.
   * @return {module:model/BookHotelRS} The populated <code>BookHotelRS</code> instance.
   */
