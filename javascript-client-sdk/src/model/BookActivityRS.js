...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EasyTravelApi.BookActivityRS = factory(root.EasyTravelApi.ApiClient);
  }
  ...
  /**
   * The BookActivityRS model module.
   * @module model/BookActivityRS
   * @version 0.1.9
   */

  /**
   * Constructs a new <code>BookActivityRS</code>.
   * Response for the activity booking confirmation
   * @alias module:model/BookActivityRS
   * @class
   */
  ...
  /**
   * Constructs a <code>BookActivityRS</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BookActivityRS} obj Optional instance to populate.
   * @return {module:model/BookActivityRS} The populated <code>BookActivityRS</code> instance.
   */
