...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EasyTravelApi.BookTransferRS = factory(root.EasyTravelApi.ApiClient);
  }
  ...
  /**
   * The BookTransferRS model module.
   * @module model/BookTransferRS
   * @version 0.1.9
   */

  /**
   * Constructs a new <code>BookTransferRS</code>.
   * Container for the tranfer booking confirmation response
   * @alias module:model/BookTransferRS
   * @class
   */
  ...
  /**
   * Constructs a <code>BookTransferRS</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BookTransferRS} obj Optional instance to populate.
   * @return {module:model/BookTransferRS} The populated <code>BookTransferRS</code> instance.
   */
