...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyTravelApi.BookActivityRS();
  });
  ...
  describe('BookActivityRS', function() {
    it('should create an instance of BookActivityRS', function() {
      // uncomment below and update the code to test BookActivityRS
      //var instane = new EasyTravelApi.BookActivityRS();
      //expect(instance).to.be.a(EasyTravelApi.BookActivityRS);
    });
