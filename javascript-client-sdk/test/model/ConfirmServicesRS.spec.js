...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyTravelApi.ConfirmServicesRS();
  });
  ...
  describe('ConfirmServicesRS', function() {
    it('should create an instance of ConfirmServicesRS', function() {
      // uncomment below and update the code to test ConfirmServicesRS
      //var instane = new EasyTravelApi.ConfirmServicesRS();
      //expect(instance).to.be.a(EasyTravelApi.ConfirmServicesRS);
    });
