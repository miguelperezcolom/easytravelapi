...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyTravelApi.CancelBookingRS();
  });
  ...
  describe('CancelBookingRS', function() {
    it('should create an instance of CancelBookingRS', function() {
      // uncomment below and update the code to test CancelBookingRS
      //var instane = new EasyTravelApi.CancelBookingRS();
      //expect(instance).to.be.a(EasyTravelApi.CancelBookingRS);
    });
