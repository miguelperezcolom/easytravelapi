...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyTravelApi.GetPortfolioRS();
  });
  ...
  describe('GetPortfolioRS', function() {
    it('should create an instance of GetPortfolioRS', function() {
      // uncomment below and update the code to test GetPortfolioRS
      //var instane = new EasyTravelApi.GetPortfolioRS();
      //expect(instance).to.be.a(EasyTravelApi.GetPortfolioRS);
    });
