...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyTravelApi.CancellationCost();
  });
  ...
  describe('CancellationCost', function() {
    it('should create an instance of CancellationCost', function() {
      ...
      //var instane = new EasyTravelApi.CancellationCost();
      //expect(instance).to.be.a(EasyTravelApi.CancellationCost);
    });

    it('should have the property retail (base name: "retail")', function() {
      // uncomment below and update the code to test the property retail
      //var instane = new EasyTravelApi.CancellationCost();
    ...
    it('should have the property gmttime (base name: "gmttime")', function() {
      // uncomment below and update the code to test the property gmttime
      //var instane = new EasyTravelApi.CancellationCost();
      //expect(instance).to.be();
    });
