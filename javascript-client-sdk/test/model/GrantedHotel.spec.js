...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyTravelApi.GrantedHotel();
  });
  ...
  describe('GrantedHotel', function() {
    it('should create an instance of GrantedHotel', function() {
      // uncomment below and update the code to test GrantedHotel
      //var instane = new EasyTravelApi.GrantedHotel();
      //expect(instance).to.be.a(EasyTravelApi.GrantedHotel);
    });
