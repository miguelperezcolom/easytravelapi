...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyTravelApi.BookHotelRS();
  });
  ...
  describe('BookHotelRS', function() {
    it('should create an instance of BookHotelRS', function() {
      // uncomment below and update the code to test BookHotelRS
      //var instane = new EasyTravelApi.BookHotelRS();
      //expect(instance).to.be.a(EasyTravelApi.BookHotelRS);
    });
