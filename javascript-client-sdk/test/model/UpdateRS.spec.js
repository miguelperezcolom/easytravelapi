...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyTravelApi.UpdateRS();
  });
  ...
  describe('UpdateRS', function() {
    it('should create an instance of UpdateRS', function() {
      // uncomment below and update the code to test UpdateRS
      //var instane = new EasyTravelApi.UpdateRS();
      //expect(instance).to.be.a(EasyTravelApi.UpdateRS);
    });
