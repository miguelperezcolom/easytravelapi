...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyTravelApi.UpdateOperation();
  });
  ...
  describe('UpdateOperation', function() {
    it('should create an instance of UpdateOperation', function() {
      // uncomment below and update the code to test UpdateOperation
      //var instane = new EasyTravelApi.UpdateOperation();
      //expect(instance).to.be.a(EasyTravelApi.UpdateOperation);
    });
