...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyTravelApi.BookTransferRS();
  });
  ...
  describe('BookTransferRS', function() {
    it('should create an instance of BookTransferRS', function() {
      // uncomment below and update the code to test BookTransferRS
      //var instane = new EasyTravelApi.BookTransferRS();
      //expect(instance).to.be.a(EasyTravelApi.BookTransferRS);
    });
