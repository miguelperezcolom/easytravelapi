...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyTravelApi.GetDataSheetRS();
  });
  ...
  describe('GetDataSheetRS', function() {
    it('should create an instance of GetDataSheetRS', function() {
      // uncomment below and update the code to test GetDataSheetRS
      //var instane = new EasyTravelApi.GetDataSheetRS();
      //expect(instance).to.be.a(EasyTravelApi.GetDataSheetRS);
    });
