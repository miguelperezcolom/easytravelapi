...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyTravelApi.GetBookingsRS();
  });
  ...
  describe('GetBookingsRS', function() {
    it('should create an instance of GetBookingsRS', function() {
      // uncomment below and update the code to test GetBookingsRS
      //var instane = new EasyTravelApi.GetBookingsRS();
      //expect(instance).to.be.a(EasyTravelApi.GetBookingsRS);
    });
