...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyTravelApi.BoardPrice();
  });
  ...
  describe('BoardPrice', function() {
    it('should create an instance of BoardPrice', function() {
      // uncomment below and update the code to test BoardPrice
      //var instane = new EasyTravelApi.BoardPrice();
      //expect(instance).to.be.a(EasyTravelApi.BoardPrice);
    });
