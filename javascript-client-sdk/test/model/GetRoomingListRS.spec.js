...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EasyTravelApi.GetRoomingListRS();
  });
  ...
  describe('GetRoomingListRS', function() {
    it('should create an instance of GetRoomingListRS', function() {
      // uncomment below and update the code to test GetRoomingListRS
      //var instane = new EasyTravelApi.GetRoomingListRS();
      //expect(instance).to.be.a(EasyTravelApi.GetRoomingListRS);
    });
