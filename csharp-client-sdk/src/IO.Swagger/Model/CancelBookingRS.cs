...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CancelBookingRS :  IEquatable<CancelBookingRS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelBookingRS" /> class.
        /// </summary>
        ...
        public CancelBookingRS(int? StatusCode = null, string Msg = null, string SystemTime = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CancelBookingRS);
        }

        /// <summary>
        /// Returns true if CancelBookingRS instances are equal
        /// </summary>
        /// <param name="other">Instance of CancelBookingRS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CancelBookingRS other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
