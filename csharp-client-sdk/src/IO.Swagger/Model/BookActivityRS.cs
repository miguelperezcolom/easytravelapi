...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BookActivityRS :  IEquatable<BookActivityRS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BookActivityRS" /> class.
        /// </summary>
        ...
        /// <param name="BookingId">The resultant booking id. You will use it to later cancel the service, if you need to.</param>
        public BookActivityRS(int? StatusCode = null, string Msg = null, string SystemTime = null, string BookingId = null)
        {
        ...
        /// </summary>
        /// <value>The resultant booking id. You will use it to later cancel the service, if you need to</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BookActivityRS);
        }

        /// <summary>
        /// Returns true if BookActivityRS instances are equal
        /// </summary>
        /// <param name="other">Instance of BookActivityRS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BookActivityRS other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
