...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetTransferPriceDetailsRS :  IEquatable<GetTransferPriceDetailsRS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransferPriceDetailsRS" /> class.
        /// </summary>
        ...
        /// <param name="CancellationCosts">Cancellation costs for this activity.</param>
        /// <param name="Remarks">Remarks which should be visible for the customer.</param>
        public GetTransferPriceDetailsRS(int? StatusCode = null, string Msg = null, string SystemTime = null, List<CancellationCost> CancellationCosts = null, List<Remark> Remarks = null)
        {
        ...
        /// </summary>
        /// <value>Cancellation costs for this activity</value>
        ...
        /// </summary>
        /// <value>Remarks which should be visible for the customer</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetTransferPriceDetailsRS);
        }

        /// <summary>
        /// Returns true if GetTransferPriceDetailsRS instances are equal
        /// </summary>
        /// <param name="other">Instance of GetTransferPriceDetailsRS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTransferPriceDetailsRS other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.CancellationCosts == other.CancellationCosts ||
                    this.CancellationCosts != null &&
                    this.CancellationCosts.SequenceEqual(other.CancellationCosts)
                ) && 
                (
                    this.Remarks == other.Remarks ||
                    this.Remarks != null &&
                    this.Remarks.SequenceEqual(other.Remarks)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CancellationCosts != null)
                    hash = hash * 59 + this.CancellationCosts.GetHashCode();
