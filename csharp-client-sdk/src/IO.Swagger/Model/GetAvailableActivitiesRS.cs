...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetAvailableActivitiesRS :  IEquatable<GetAvailableActivitiesRS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAvailableActivitiesRS" /> class.
        /// </summary>
        ...
        /// <param name="AvailableActivities">List of the available activities for that resort and dates.</param>
        public GetAvailableActivitiesRS(int? StatusCode = null, string Msg = null, string SystemTime = null, List<AvailableActivity> AvailableActivities = null)
        {
        ...
        /// </summary>
        /// <value>List of the available activities for that resort and dates</value>
        [DataMember(Name="availableActivities", EmitDefaultValue=false)]
        public List<AvailableActivity> AvailableActivities { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetAvailableActivitiesRS);
        }

        /// <summary>
        /// Returns true if GetAvailableActivitiesRS instances are equal
        /// </summary>
        /// <param name="other">Instance of GetAvailableActivitiesRS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAvailableActivitiesRS other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.AvailableActivities == other.AvailableActivities ||
                    this.AvailableActivities != null &&
                    this.AvailableActivities.SequenceEqual(other.AvailableActivities)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AvailableActivities != null)
                    hash = hash * 59 + this.AvailableActivities.GetHashCode();
                return hash;
            }
        }
